              ...
              <div className="flex items-center justify-end pr-16 lg:pr-0">
                {!isSignedIn ? (
                  <>
                    ...
                    <Link
                      href="/signup"
                      className="ease-in-up hidden rounded-md bg-sixthColor px-8 py-3 text-base font-bold text-white transition duration-300 hover:bg-opacity-90 hover:shadow-signUp md:block md:px-9 lg:px-6 xl:px-9"
                    >
                      Sign Up
                    </Link>
                  </>
